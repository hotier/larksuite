...
import { FileText, Plus, Trash2, FileCode } from 'lucide-react';
                ...
                >
                  <div className="flex-1 min-w-0 flex items-center gap-2.5">
                    ...
                    <a
                      ...
                      className="text-sm font-medium text-neutral-800 truncate group-hover:text-blue-600 transition-colors"
                    >
                      {file.name}
                    </a>
                  </div>
